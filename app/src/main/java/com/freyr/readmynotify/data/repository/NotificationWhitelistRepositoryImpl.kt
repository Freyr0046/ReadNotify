...
class NotificationWhitelistRepositoryImpl @Inject constructor(
    ...
    override suspend fun setAppEnabled(packageName: String, enabled: Boolean): Result<Unit> =
        runCatching { dataSource.setAppEnabled(packageName, enabled) }
}
